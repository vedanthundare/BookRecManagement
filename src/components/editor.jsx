export function Editor(){
    return(
        ...
        <div class="my-5">
            <h2 class="mb-5 font-bold text-center md:text-left">AUDIO-BOOKS TO BE EDITED:</h2>
            <div class="flex flex-col md:flex-row border border-gray-300 p-5 bg-white">
                ...
                <div class="flex flex-col flex-grow">
                    ...
                    <p class="my-1 font-bold">Examined by:</p>
                    ...
                    <textarea placeholder="Editing to be done:" class="p-2 border border-gray-300 rounded my-2 h-24"></textarea>
                    <div class="flex items-center my-2">
                        <input type="file" id="fileInput" class="hidden" multiple/>
                        <label for="fileInput" class="flex-grow p-2 border border-gray-300 rounded-l cursor-pointer bg-white hover:bg-gray-100">Choose Files</label>
                        <button type="button" class="p-2 bg-red-500 text-white cursor-pointer rounded-r h-full hover:bg-red-600" onclick="clearFileInput()">Cancel</button>
                    </div>
                    <div id="fileList" class="mt-2 rounded border border-gray-300">
