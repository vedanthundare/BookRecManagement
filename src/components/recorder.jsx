export function Recorder(){
    return(
        ...
        <header class="flex flex-col md:flex-row items-center py-5">
            <div class="profile-pic w-24 h-24 bg-gray-300 rounded-full mb-4 md:mb-0 md:mr-5">
                <img src="#" alt="#" class="w-full h-full rounded-full"/>
            </div>
            <div class="profile-info flex flex-col items-center md:items-start">
                <h1 class="m-0 text-xl font-bold">NAME</h1>
                <p class="my-1">Recorder</p>
                <p class="my-1">Volunteer since 2020</p>
                <button class="bg-yellow-300 border-none py-2 px-4 cursor-pointer mt-2 md:mt-0 font-bold  hover:bg-yellow-400 rounded-md">Edit Profile</button>
            </div>
        </header>
        ...
        <div class="audio-books my-5">
            <h2 class="mb-5 font-bold text-center md:text-left">BOOKS RECORDED:</h2>
            <div class="audio-book flex flex-col md:flex-row border border-gray-300 p-5 bg-white">
                <img src="#" alt="#" class="w-full md:w-36 h-48 mb-4 md:mb-0 md:mr-5"/>
                <div class="book-details flex flex-col flex-grow">
                    <h3 class="m-0 text-lg font-bold">Book Name</h3>
                    ...
                    <p class="my-1 font-bold">Status:</p>
                    <div class="button-container flex flex-col md:flex-row items-center mt-2">
                        <button class="mr-0 md:mr-2 mb-2 md:mb-0 p-2 bg-gray-300 border-none cursor-pointer font-bold  hover:bg-gray-400">DOWNLOAD</button>
                        <button class="submit-btn p-2 bg-gray-300 border-none cursor-pointer font-bold  hover:bg-gray-400">SUBMIT</button>
                    </div>
                </div>
            </div>
        </div>
